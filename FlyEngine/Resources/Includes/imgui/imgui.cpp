...
/*
 ...
 - Mouse:
    ...
    - Consoles/BG_Tablet/Phone users: Consider using a Synergy 1.x server (on your PC) + uSynergy.c (on your console/tablet/phone app) to share your PC mouse/keyboard.
 ...
 A: Short explanation:
    ...
    User code may do:
        ...
        MyTexture* texture = g_CoffeeBG_TableTexture;
